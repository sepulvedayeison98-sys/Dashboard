# Script de actualización de datos para Dashboard CEDI
# Copia los Excel desde OneDrive a C:\DashboardCEDI\
...
foreach ($a in $archivos) {
    ...
    if (Test-Path $src) {
        ...
        Write-Host ('  [AVISO] No encontrado (normal en PC personal): ' + $a.src)
    }
}
